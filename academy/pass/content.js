...
const cases=[
 ...
 make('sup-mean','RCT差异性／优效：两组均值差','rct','continuous','优效性 / 独立末次结局','mean','sprint','迁移任务：一项新的血压RCT以第6个月收缩压为主要结局。预计试验组T均值125、对照组C为130 mmHg，两组SD均12 mmHg。1:1随机，双侧Ⅰ类错误5%，把握度80%，失访10%。请按T−C的有符号差值填写，比较末次水平，不使用各组内前后检验。',{delta:-5,sdT:12,sdC:12},'t11'),
 make('sup-binary','RCT差异性／优效：两组事件比例','rct','binary','优效性 / 风险差','binary','sprint','迁移任务：另设一项固定12个月的二分类结局RCT，预计试验组T不良事件风险10%、对照组C为15%。按1:1分配，双侧Ⅰ类错误5%，把握度80%，失访10%。这是教学用固定时点风险比较，不复现SPRINT原研究的时间至事件主分析。',{pT:.1,pC:.15},'t12'),
